...
export default function Hero() {
    ...
    return (
        <section id="hero" className="flex flex-col gap-8 items-center overflow-hidden justify-center w-full min-h-svh py-24 px-4 relative bg-gradient-to-b from-transparent from-80% to-white">
            <img src="/hero1.png" className="-z-10 absolute opacity-20 w-full h-full object-cover" />
            {/* <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></div> */}
            <div className="flex flex-row items-center gap-2 px-4 py-2 bg-primary rounded-full text-white text-xs md:text-sm">
                <Crown className="size-3 md:size-4" />
                <p>Lideres en automatización papelera</p>
            </div>
            <h1 className="text-4xl lg:text-6xl font-bold text-center max-w-5xl">
            ...
            <p className="text-sm text-center text-gray-600 mt-10">*Representantes y distribuidores autorizados de marcas líderes en automatización y medición*</p>
